...
# Create input sequences and corresponding target characters
sentences = []
next_characters = []
...
model.save('textgenerator_model.h5')  # Save the trained model

# Load the model
model = load_model('textgenerator_model.h5')
